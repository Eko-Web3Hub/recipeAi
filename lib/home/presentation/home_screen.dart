              ...
              child: Column(
                ...
                children: [
                  ...
                  const Row(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [_HeadLeftSection(), NotificationIcon()],
                  ),
                  const Gap(15),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  ...
                  BlocListener<HomeScreenController, HomeScreenState>(
                    listener: (context, homeScreenState) {
                      if (homeScreenState is HomeScreenStateRequiresLogin) {
                        showSnackBar(
                          context,
                          appTexts.sessionExpiredLoginAgain,
                          isError: true,
                        );
                        context.go('/onboarding/start/login');
                      }
                    },
                    child: BlocBuilder<HomeScreenController, HomeScreenState>(
