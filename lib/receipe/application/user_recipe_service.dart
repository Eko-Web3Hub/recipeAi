...
abstract class IUserRecipeService {
  ...
  Stream<List<UserRecipeV2>> watchAllSavedReceipes();
}

class UserRecipeService implements IUserRecipeService {
  const UserRecipeService(this._userReceipeRepositoryV2, this._authUserService);
  ...
  Future<void> saveUserReceipeMetadata(
    ...
    return _userReceipeRepositoryV2.saveUserReceipeMetadata(
      uid,
      metadata.updateLastRecipesHomeUpdatedDate(lastUpdatedDate),
    );
  }
