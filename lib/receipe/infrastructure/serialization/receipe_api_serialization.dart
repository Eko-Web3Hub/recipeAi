...
abstract class ReceipeApiSerialization {
  static Receipe fromJson(Map<String, dynamic> json) {
    return Receipe(
      name: json["name"],
      ingredients: (json["ingredients"] as List).map<Ingredient>((ingredient) => IngredientSerialization.fromJson(ingredient),).toList() ,
      steps:(json["steps"] as List).map<ReceipeStep>((step) => StepSerialization.fromJson(step),).toList(),
